...
import { TrendingUp, MessageCircle, PlusCircle, ThumbsUp, BookOpen } from "lucide-react"
              ...
              {filteredTutorials.length > 0 ? (
                filteredTutorials.map((tutorial) => (
                  <Link
                    ...
                    className="block bg-card rounded-xl p-5 shadow-sm border border-border hover:shadow-md transition-shadow animate-in fade-in slide-in-from-bottom-2 duration-300"
                  >
