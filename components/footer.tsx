      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground">Serapeu</span>
            </Link>
            <p className="text-muted-foreground text-sm max-w-md">
              O lugar onde o conhecimento é compartilhado passo a passo. Aprenda, ensine e cresça com a comunidade.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link
                href="/"
                className="block text-sm text-muted-foreground hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
              >
                Início
              </Link>
              <Link
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-muted-foreground hover:text-amber-600 dark:hover:text-amber-400 transition-colors flex items-center gap-1.5"
            >
        ...
        <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Serapeu. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://github.com/seu-usuario/serapeu"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
              aria-label="GitHub"
